...
public class RatingAndViewDeliveryPersonRatingSteps {
    ...
    public void delivery_person_dp1_has_a_of_ratings(String list) {
        ...
        ratingSystem.getDeliveryPersonRatings().put(deliveryPerson.getUserID(), listOfRating);
        System.out.println(deliveryPerson.getName()+" rating = " + ratingSystem.getDeliveryPersonRatings().get(deliveryPerson.getUserID()));
    }
    ...
    public void the_campus_user1_rates_the_delivery_person_with_out_of(int rating) {
        ...
        campusUser1.rateDeliveryPersonByUser(ratingSystem, deliveryPerson.getUserID(), rating);
    }
    ...
    public void the_rating_of_this_delivery_person_should_be_out_of(double expectedRating) {
        Double actualRating = ratingSystem.averageRating(deliveryPerson.getUserID());
        assertEquals(actualRating, expectedRating);
        System.out.println("List of rating of this delivery person = " + ratingSystem.getDeliveryPersonRatings().get(deliveryPerson.getUserID()));
