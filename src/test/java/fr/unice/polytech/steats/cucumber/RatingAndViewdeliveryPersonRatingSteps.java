...
public class RatingAndViewdeliveryPersonRatingSteps {
    ...
    public void delivery_person_is_rated_at_stars(Integer rating) {
        ...
        System.out.println(deliveryPerson.getName()+" rating = " + ratingSystem.getDeliveryPersonRatings().get(deliveryPerson.getUserID())); // 2 starts
    }
    ...
    public void the_campus_user1_rates_the_delivery_person_stars(Integer rating) {
        ...
        campusUser1.rateDeliveryPersonByUser(ratingSystem, deliveryPerson.getUserID(), ratingLevel);
    }
    ...
    public void the_rating_of_this_delivery_person_should_be_stars(Integer expectedRating) {
        RatingLevel actualRating = ratingSystem.getDeliveryPersonRatings().get(deliveryPerson.getUserID());
